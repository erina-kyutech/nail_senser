...
def build_input_image(bgr_img, mode="rgb"):
    ...
    """
    if mode == "rgb":
        print("mode:", mode, "model_dir:", CNN.model_dir)
...
class multitask_CNN(object):
    ...
    def __init__(self, img_mode="g"):
        ...
        self.model_dir = f"./result/CNN_result/vgg16_{img_mode}/"
...
class Trainer(object):
    ...
    def data_indexread(self, datas_df, index_array):
        ...
        X_array = np.array(X_img_list)  # (N,155,140,3)

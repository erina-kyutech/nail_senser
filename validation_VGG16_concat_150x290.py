...
class multitask_CNN(object):
    ...
    def __init__(self):
        ...
        self.model_dir = "./result/CNN_result/vgg16_gray/"  # change if your trained model folder differs
#指定したディレクトリがなければ作る
    ...
    def CNN_build(self):
        ...
        input_tensor = Input(shape=(150,290,1),name="input_tensor")  # NOTE: grayscale model
        ...
        conv_input = Lambda(tensor_gray2BGR,
                            output_shape=(150,290,3),
                            name="gray2BGR")(input_tensor)
        conv_inputshape = (150,290,3)

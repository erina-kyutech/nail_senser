...
import validation_VGG16_robot
import axis_satuei_4houkou_robot
import cv2
...
gf2000 = axis_satuei_4houkou_robot.gf2000
SC800IM700_1 = axis_satuei_4houkou_robot.SC800IM700_1
SC800IM700_2 = axis_satuei_4houkou_robot.SC800IM700_2
SC800IM700_3 = axis_satuei_4houkou_robot.SC800IM700_3
SC800IM700_4 = axis_satuei_4houkou_robot.SC800IM700_4


class RealTime:

    def __init__(self):
        self.gf2000 = axis_satuei_4houkou_robot.gf2000
        self.SC800IM700_1 = axis_satuei_4houkou_robot.SC800IM700_1
        self.SC800IM700_2 = axis_satuei_4houkou_robot.SC800IM700_2
        self.SC800IM700_3 = axis_satuei_4houkou_robot.SC800IM700_3
        self.SC800IM700_4 = axis_satuei_4houkou_robot.SC800IM700_4
        self.CNN = validation_VGG16_robot.multitask_CNN()
    ...
    def graph(self):
        ...
        show_num = 100  #横軸に表示されるデータの数 例: show_num = 10 は、X 軸に 10 個のデータのみが表示されることを意味します。
        num = 0

        plt.ion()  # インタラクティブモードをオンにする
        #fig1 = plt.figure(figsize=(100, 80))  #画像サイズの設定
        plt.xlim(0, show_num)  # 横軸の数値表示範囲を設定
        plt.ylim(-10, 10)
        #x_major_locator = MultipleLocator(100000)  # 横軸の目盛り間隔を 2 に設定します
        #y_major_locator = MultipleLocator(10)  # 縦軸の目盛り間隔を10に設定します
        ax = plt.gca()  # ax は 2 つの座標軸の例です
        #ax.xaxis.set_major_locator(x_major_locator)  # 横軸のメインスケールを 2 の倍数に設定します
        #ax.yaxis.set_major_locator(y_major_locator)  # 縦軸の主スケールを 10 の倍数に設定します
        ...
        while True:
            ...
            # plt.rcParams["font.size"] = 25
            # plt.figure(2)
            # plt.plot(temp_list_time, temp_list_Fx_True, c='b', ls='-',linewidth=2)
            # plt.plot(temp_list_time, temp_list_Fx_Predict, c='g', ls='-',linewidth=2)
            # plt.ylim(0, 4)
